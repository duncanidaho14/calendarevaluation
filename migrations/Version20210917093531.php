 ...
 */
final class Version20210917093531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, commercial_id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, date DATETIME NOT NULL, date_end DATETIME NOT NULL, INDEX IDX_65E8AA0A7854071C (commercial_id), INDEX IDX_65E8AA0AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
